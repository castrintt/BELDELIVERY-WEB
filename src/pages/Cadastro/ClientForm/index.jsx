...
const ClientForm = () => {
  ...
  const imgUrl =
    "https://firebasestorage.googleapis.com/v0/b/beldelivery-f4426.appspot.com/o/user%2Fanonimo.png?alt=media&token=3cd2a9df-8b5a-4a4c-aaa9-aa7a92e90376";
  ...
  const DataVerify = (e) => {
    ...
    let passwordConfirmateValidated = passwordRegisterConfirmation(
      formData.password,
      formData.confirmatedPassword
    );
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    confirmatedPassword: e.target.value,
                  })
                }
