    ...
    <Router>
      <Suspense>
        <Routes>
          ...
          <Route path='/cadastro/cliente' element={<OthersLazy.RegisterClient />}/>
          <Route path='/cadastro/loja' element={<OthersLazy.RegisterStore />}/>
          <Route path='/sem-autorizacao' element={<OthersLazy.NotAuthAcess />}/>
          ...
          <Route element={<AuthRequiredRoutes required={users.client} />}>
            ...
            <Route path='/perfil/enderecos' element={<ClientLazy.PerfilClient />}/>
            <Route path='/perfil/pedidos' element={<ClientLazy.OrdersClient />}/>
            <Route path='/perfil/alterar-senha' element={<ClientLazy.ChangePasswordClient />}/>
            <Route path='/lojas' element={<ClientLazy.Home />}/>
            <Route path='/lojas/:store' element={<ClientLazy.PerfilStore />}/>
            <Route path='/descobrir/:category' element={<ClientLazy.CategoryClient />}/>
          </Route>
          ...
          <Route element={<AuthRequiredRoutes required={users.store} />}>
            ...
            <Route path='/gerenciar/produtos' element={<StoreLazy.Products />}/>
            <Route path='/gerenciar/pedidos' element={<StoreLazy.OrdersStore />}/>
            <Route path='/gerenciar/endereco' element={<StoreLazy.Gerenciar />}/>
            <Route path='/gerenciar/alterar-senha' element={<StoreLazy.ChangePasswordStore />}/>
          </Route>
        </Routes>
      </Suspense>
    </Router>
